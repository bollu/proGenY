...
/*! Used to watch for events with the EventManager 
...
coupling between parts of the engine. Rather, the EventManager acts as a mediator between
...
class Observer{
public:
	/*! Receive a particular event that has been sent to the EventManager
...
public:
	...
	/*! Used to register an Observer with the EventManager
	...
	*/
	...
	/*!Used to un register an Observer with the EventManager
