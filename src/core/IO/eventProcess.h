...
mouse clicks and mouse motion. The events are then sent to the EventManager. 
...
*/   
 ...
 public:
 	eventProcess(processMgr &processManager, Settings &settings, EventManager &_eventManager) :
 	...
 	/*! Processes events and sends them to EventManager*/
 	void preUpdate();
